<script setup>
        ...
        const tab = reactive({
            arr: [
                { name: "1", title: '边锦吉编程', content: '内容1' },
                { name: "2", title: '边锦吉编程', content: '内容2' },
                { name: "3", title: 'bianjinjicode.com', content: '内容3' },
            ]
        })
    ...
    <template>
        ...
        <el-tabs v-model="selectedName" @tab-click="tabClick">
            <el-tab-pane label="边锦吉" name="1">内容1</el-tab-pane>
            <el-tab-pane label="边锦吉编程" name="2">内容2</el-tab-pane>
            <el-tab-pane label="dengruicode.com" name="3">内容3</el-tab-pane>
        </el-tabs>

        <h3>卡片风格</h3>
        <el-tabs v-model="selectedName" @tab-click="tabClick" type="card">
            <el-tab-pane label="边锦吉" name="a">内容1</el-tab-pane>
            <el-tab-pane label="边锦吉编程" name="b">内容2</el-tab-pane>
            <el-tab-pane label="bianjinjicode.com" name="b">内容3</el-tab-pane>
        </el-tabs>
        ...
        <el-tabs v-model="selectedName" @tab-click="tabClick" type="border-card">
            <el-tab-pane label="边锦吉" name="A">内容1</el-tab-pane>
            <el-tab-pane label="边锦吉编程" name="B">内容2</el-tab-pane>
            <el-tab-pane label="bianjinjicode.com" name="C">内容3</el-tab-pane>
        </el-tabs>
